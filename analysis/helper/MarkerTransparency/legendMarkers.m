function legendMarkers(handle,hLegend,lMarker,alphas)
...
for i=1:length(lMarker)
    ...
    setMarkerColor(handle(i),lMarker(i,:),alphas(i));
end
...
for isymbol = 1:length(hLegendComponents)
    ...
    setMarkerColor(hLegendMarker,lMarker(icolor,:),alphas(i)); % Apply transparency to marker
end

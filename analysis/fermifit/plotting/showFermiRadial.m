function showFermiRadial(atomdata)
...
for kk=1:length(atomdata)
    ...
    strG=['Gaussian $' num2str(round(atomdata(kk).FermiGaussFit{1}.Temperature*1e9,1)) '~\mathrm{nK}$'];
    ...
    text(5,5,strN,'interpreter','latex','fontsize',12,'units','pixels',...

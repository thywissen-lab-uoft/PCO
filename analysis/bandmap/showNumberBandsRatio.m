...
hF.SizeChangedFcn = @myresize;
    function myresize(~,~)
        try
            [p1(1), p1(2), p1(3), p1(4)] = getAxesPos(1,3,hF.Position(3),hF.Position(4));
            hax1.Position = p1;
            [p2(1), p2(2), p2(3), p2(4)] = getAxesPos(2,3,hF.Position(3),hF.Position(4));
            hax2.Position = p2;
            [p3(1), p3(2), p3(3), p3(4)] = getAxesPos(3,3,hF.Position(3),hF.Position(4));
            hax3.Position = p3;
